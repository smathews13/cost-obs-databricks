-- DBSQL Cost Per Query Materialized View (PrPr)
...
-- Reference implementation for cost observability dashboard
...
cleaned_warehouse_info AS (
 ...
 LEFT JOIN utilization_by_warehouse AS ut ON wu.warehouse_id = ut.warehouse_id
