...
if missing_access:
    ...
    print("\n".join(grant_lines))
    raise RuntimeError(
        "Source-table permission preflight failed. Run the GRANT SQL printed above, "
