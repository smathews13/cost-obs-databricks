    ...
    try:
        with (
            ...
            patch.object(
                ...
                return_value=db.CacheGeneration("apps:dashboard-bundle:v2:all", 0),
            ),
    ...
    try:
        with (
            ...
            patch.object(
                aiml,
                "capture_cache_generation",
                return_value=db.CacheGeneration("aiml:dashboard-bundle:v2", 0),
            ),
...
def _cache_generation_child(state_path: str, lock_path: str, connection):
    ...
    generation = db.capture_cache_generation("apps:dashboard-bundle:v2:all")
